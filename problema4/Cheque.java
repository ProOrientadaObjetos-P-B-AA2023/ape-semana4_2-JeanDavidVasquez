...
class Cheque1 {
    ...
    public Cheque1(String cliente, double valorCheque, Banco banco) {
...
public class Cheque {
    public static void main(String[] args) {
        Cliente cliente= new Cliente("Jean","Vasquez","1105822231");
        Banco banco= new Banco("Pichincha",8);
        Cheque1 cheque=new Cheque1("Cliente",10000,banco);
